...
import hristostefanov.minirxdemo.presentation.FormattedPostSummary
import kotlinx.android.synthetic.main.post_list_item.view.*

class PostAdapter(private val list: List<FormattedPostSummary>): RecyclerView.Adapter<PostAdapter.PostViewHolder>() {
